...
export function HomeTabs({ children }: HomeTabsProps) {
	const [activeTab, setActiveTab] = useState<"upload" | "how-to">("upload");
		...
		<div className="flex max-w-4xl flex-col gap-8">
				...
				<div className="flex flex-col gap-4">
					<div className="rounded-lg border border-border bg-background p-4">
						...
						<ul className="ml-4 list-disc space-y-2 text-sm text-muted-foreground">
							...
							<li>
								<strong className="text-foreground">Threshold lines:</strong>
								Horizontal dashed lines marking important limits (e.g., 7V brownout,
								120A main breaker)
							</li>
							<li>
					...
					<div className="rounded-lg border border-border bg-background p-4">
						...
						<ul className="ml-4 list-disc space-y-2 text-sm text-muted-foreground">
							...
							<li>
								<strong className="text-foreground">P90 (90th Percentile):</strong>
								Value that 90% of samples are below. Shows performance under heavy
								load.
							</li>
							<li>
					...
					<div className="rounded-lg border border-border bg-background p-4">
						...
						<ul className="ml-4 list-disc space-y-2 text-sm text-muted-foreground">
							...
							<li>
								<strong className="text-foreground">Internal resistance (R):</strong>
								Higher resistance means more voltage drop under load. As batteries
								age, resistance increases — shown by rising impedance over time.
							</li>
							<li>
			...
			<div className="flex flex-col gap-4 rounded-lg border border-border bg-card p-6">
				...
				<ul className="ml-4 list-disc space-y-2 text-sm text-muted-foreground">
					...
					<li>
						<strong className="text-foreground">High CAN Utilization:</strong>
						Reduce CAN message frequency or combine sensor data
					</li>
					<li>
