  ...
  return (
    <div className="w-full max-w-sm flex flex-col items-center gap-10">
      ...
      <div className="flex flex-col items-center gap-1">
        <span className="text-3xl font-bold tracking-tight font-mono uppercase">
          Polar Edge
        </span>
        <TypographyLabel>
          YETI Robotics &middot; 3506
        </TypographyLabel>
      </div>
      ...
      <div className="w-full space-y-6">
        ...
        {signupParam === "restricted" && (
          <p className="rounded-lg bg-destructive/10 border border-destructive/20 px-4 py-3 text-sm text-destructive">
            Sign-up is invite-only. Use an invite link from your organization
            or contact an admin.
          </p>
        )}
      ...
      <div className="flex items-center gap-2 text-muted-foreground/50">
        ...
        <TypographyMuted className="text-muted-foreground/50">FRC Scouting Platform</TypographyMuted>
        <div className="h-px w-8 bg-border" />
      </div>
    </div>
  );
