...
const PAGES = [
  { label: "Basic Data ", component: StandForm }, //index 0
  { label: "Scoring Capabilities ", component: EndGame },
  { label: "Comments From Match", component: AfterSubmitComment }, //index 1 (REMEMBER THIS)
];
